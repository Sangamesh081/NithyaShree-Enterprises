...
export default function RegisterPage({ onRegisterSuccess, onNavigateLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Save registered user details & exact password!
    const newUser = {
      role: 'user',
    ...
    alert(`Account created successfully for ${newUser.name}! Please log in with your email/phone and password.`);
    onNavigateLogin();
  };
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginTop: '0.35rem' }}>
            Join Nityashree Enterprises to schedule verified specialists & manage home services.
          </p>
        </div>
